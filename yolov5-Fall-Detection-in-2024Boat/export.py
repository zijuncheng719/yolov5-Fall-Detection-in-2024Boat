...
def parse_opt():
    ...
    """
    # weights = "data/model/yolov5s05_320/weights/best.pt"  # 模型文件yolov5s05_320
    # input_size = [320, 320]
    # weights = "./data/model/yolov5s05_416/weights/best.pt"  # 模型文件yolov5s_640
    # input_size = [416, 416]
    weights = "data/model/yolov5s_640/weights/best.pt"  # 模型文件yolov5s05_640
    input_size = [640, 640]
